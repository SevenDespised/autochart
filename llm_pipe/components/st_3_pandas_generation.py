...
class Processor(IProcessor):
    ...
    def generate_prompt(self, input_data, data: StageExecutionData):
        ...
        self.db_name = initial_input["db_name"]
        # 获取输入数据中的查询文本
        ...
        prompt_optimizer.add_template(os.path.join(BASE_DIR, TEMPLATE_PATH, "3_pandas_generation.tpl"), 
                                    ...
                                    #TABLE_PATH = os.path.join(BASE_DIR, DB_DIR, initial_input["db_name"]),
                                    HINT = hint,
                                    COLS = cols,
    ...
    def post_process(self, output_data):
        ...
        local_dict = {"table_dir": os.path.join(BASE_DIR, DB_DIR, self.db_name)}
