...
from data_utils import load_dataset, preprocess_data, create_chart_type_mapping, load_chart_type_mapping
...
class ChartClassifier:
    ...
    def train(self, save_model: bool = True) -> lgb.Booster:
        ...
        if save_model:
            ...
            self.chart_type_mapping = create_chart_type_mapping(
    ...
    def load_chart_type_mapping(self) -> Dict[int, str]:
        ...
        mapping_path = os.path.join(self.paths['output'], 'chart_type_mapping.pkl')
        try:
            self.chart_type_mapping = load_chart_type_mapping(
