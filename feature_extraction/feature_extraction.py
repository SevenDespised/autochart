...
base_dir = "../"
base_dir = ""
raw_df_chunks = load_raw_data(chunk_size=CHUNK_SIZE, data_file_name = base_dir + f"data/raw_data_all.csv")
...
df_o = pd.read_csv(base_dir + f"features/field_level_outcomes_df.csv")
df_f = pd.read_csv(base_dir + f"features/field_level_features_df.csv")
...
df_train.to_csv((base_dir + f"features/feature_train.csv"), index=False)
df_test.to_csv((base_dir + f"features/feature_test.csv"), index=False)
